...
---
# service_v2 Flask Application

Awesome service_v2 created by 
...
```bash
git clone https://github.com//service_v2 service_v2
cd service_v2
make install
```
...
```bash
service_v2 create-db   # run once
service_v2 populate-db  # run once (optional)
service_v2 add-user -u admin -p 1234  # ads a user
service_v2 run
```
