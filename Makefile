...
lint:             ## Run pep8, black, mypy linters.
	...
	$(ENV_PREFIX)mypy --ignore-missing-imports service_v2/
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "service_v2 = 'service_v2.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run service_v2'"
